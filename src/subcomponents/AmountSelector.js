    ...
    return (
        <div className="amount-selector-container">
            <svg className="sign" width="2rem" onClick={() => {
                ...
                enable-background="new 0 0 512 512" version="1.1" viewBox="0 0 512 512" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="sign" width="2rem" onClick={() => {
                ...
                enable-background="new 0 0 490.2 490.2" version="1.1" viewBox="0 0 490.2 490.2" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
