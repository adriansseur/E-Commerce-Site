    ...
    return (
        <div className="header-container">
            ...
            <div id="clickables-container">
                ...
                <svg id="cart" onClick={handleCartClick} height="2rem"enableBackground="new 0 0 60 60" version="1.1" viewBox="0 0 60 60" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
