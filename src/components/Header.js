    ...
    return (
        <div className="header-container">
            ...
            <div id="clickables-container">
                ...
                <svg id="cart" onClick={handleCartClick} height="2rem"enable-background="new 0 0 60 60" version="1.1" viewBox="0 0 60 60" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg id="menu" onClick={handleMenuClick} height="1.5rem" enable-background="new 0 0 150 150" version="1.1" viewBox="0 0 150 150" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
